...
const PlayerCard = ({ playerData, isOnRightSide, small }) => {
  ...
  return (
    <li
      ...
      className={`flex ${isOnRightSide && `flex-row-reverse`} ${small ? "text-xs" : ""}`}
    >
      <div
      ...
      >
        ...
        ></div>
        <img
          className={`h-[${small ? "3.5rem" : "8rem"}] ${isOnRightSide && `scale-x-[-1]`}`}
